...
allfilenames = myfunctions.readFilesNameList("/home/jesal/onedump/")
filenames = []
for item in allfilenames:
    filenames.append(item.replace("/home/jesal/onedump/",""))
...
for item in articlenames:
    ...
    myfunctions.insKeywordCountinDB(sortedkeywordCountDict, 'tempdb', item.lower())
